...
abstract class AppLocalizations {
  ...
  /// No description provided for @my_account_text.
  ///
  /// In en, this message translates to:
  /// **'My Account'**
  String get my_account_text;
  ...
  /// No description provided for @general_management_text.
  ///
  /// In en, this message translates to:
  /// **'General Management'**
  String get general_management_text;

  /// No description provided for @settings_text.
  ///
  /// In en, this message translates to:
  /// **'Settings'**
