...
class LoadMoreListVerticalView extends StatefulWidget {
  ...
  const LoadMoreListVerticalView({
    Key? key,
    required this.child,
...
class _LoadMoreState extends State<LoadMoreListVerticalView> {
  Widget get child => widget.child;

  LoadMoreDelegate get loadMoreDelegate => widget.delegate ?? LoadMoreListVerticalView.buildDelegate();
      ...
      child: NotificationListener<_BuildNotify>(
        child: NotificationListener<ScrollNotification>(
          ...
          child: DefaultLoadMoreView(
            ...
            textBuilder: widget.textBuilder ?? LoadMoreListVerticalView.buildTextBuilder(),
          ),
        ),
